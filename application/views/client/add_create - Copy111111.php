                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <form role="form" action="" name="frmChange" method="post">
									  <div class="col-md-12">
									  <div class="col-md-12">
                                        <div class="form-group">
											  <label for="sel1">Select list:</label>
											  <select class="form-control" id="aioConceptName" required>
...
$(function() {
  ...
  $("#aioConceptName").on("change", function() {
   ...
   var b = $("#aioConceptName").val();
   location.replace("<?php echo base_url(); ?>index.php/client/add_create/?language="+b)
  })
});
</script>
<script>
